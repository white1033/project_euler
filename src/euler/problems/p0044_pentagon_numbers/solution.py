...
def solve():
    ...
    while True:
        ...
        # Optimization:
        # If we have a candidate min_d, and the smallest possible difference for this k
        # (which is P_k - P_{k-1}) is already larger than min_d, then no pair (P_k, P_j)
        # can produce a difference smaller than min_d.
        ...
        for j in range(k - 2, -1, -1):
            ...
            if is_pentagonal(diff) and is_pentagonal(p_k + p_j):
                # Found a valid pair!
